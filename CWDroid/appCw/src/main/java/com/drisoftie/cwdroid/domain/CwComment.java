...
public class CwComment extends BaseEntity {
    ...
    public CwComment(int cid, int commentcount, int currpage, String mode, int pagecount, int postcount, String quote, String statement,
                     int uid, int unixtime, String username, String usertitle, CwNews cwNews) {
        super();
        this.cid = cid;
