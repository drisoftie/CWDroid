...
import com.drisoftie.cwdroid.api.XmlRoot;
 ...
 */
public class FragBag extends FragPage {
    ...
    public void onResuming() {
        new ActionBuilder<>().
                                     with(findViewById(R.id.btn_travel_bags_add)).reg(
                View.OnClickListener.class, RegActionMethod.SET_ONCLICK).pack(
                new AsyncAction<View, Object, Object, Object>(null, null) {
                    ...
                    @Override
                    public void onActionAfterWork(String methodName, Object[] methodArgs, Object workResult, Object tag1, Object tag2,
                                                  Object[] additionalTags) {
