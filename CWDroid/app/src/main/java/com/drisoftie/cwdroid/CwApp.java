...
public class CwApp extends Application {
    ...
    * ################*/
    ...
    public void onCreate() {
        ...
        ImageLoaderConfiguration config = new ImageLoaderConfiguration.Builder(getApplicationContext()).diskCache(
                ...
                new DisplayImageOptions.Builder().showImageOnLoading(R.drawable.ic_android).cacheInMemory(true).cacheOnDisk(true).build())
                                                                                                       .build();
